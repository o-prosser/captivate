...
2. $\ce{C—C}$ and $\ce{C—H}$ bonds in alkanes as $\rho$-bonds
3. mechanism of radical substitution, such as the photochlorination of alkanes
4. difference in reactivity between alkanes and alkenes in terms of the C=C bond as a region of high electron density
5. $\ce{C=C}$ bond in ethene and other alkenes as comprising π-bond and $\rho$-bond
6. $\ce{E–Z}$ isomerism in terms of restricted rotation about a carbon-carbon double bond
7. mechanism of electrophilic addition, such as in the addition of Br2 to ethene, as a characteristic reaction of alkenes
